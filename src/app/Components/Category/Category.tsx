            ...
            <div className="grid grid-cols-6 gap-[30px] place-items-center mt-[60px]">
                {
                    categoriesData.map((element,idx)=> {
                        return <div key = {idx} className="w-[170px] group hover:bg-[#DB4444] h-[145px] flex flex-col items-center justify-center gap-[16px] border-[1px] border-[#0000004D] rounded-[4px]">
